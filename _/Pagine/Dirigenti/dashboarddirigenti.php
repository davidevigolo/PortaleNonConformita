...
<div id="flexcontainer" style="display: flex; flex-wrap: wrap; margin:auto;">
<div id="container" style="flex: 30%; margin: 10px 10px">
    <div id="subtitle">Visuale generale stato non conformità</div>
...
<div id="container" style="flex: 100%; margin: 10px 10px">
    <div id="subtitle">N.C. Aperte/Chiuse per reparto</div>
...
<div id="container" style="flex: 100%; margin: 10px 10px">
    <div id="subtitle">Andamento cronologico non conformità</div>
    <div id="chartContainer" style="height: 370px; width: 100%;"><canvas id="areachart" style="margin: auto; height: 100%; width: 100%"></canvas></div>
</div>
