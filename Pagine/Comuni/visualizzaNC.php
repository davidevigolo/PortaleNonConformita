...
*/
        ...
        $q="SELECT DISTINCT SE.ID, SE.DATACREAZIONE, IFNULL(SE.DATACHIUSURA,'NON SPECIFICATA') AS DATACHIUSURA, SE.AUTORE, SE.STATO FROM SEGNALAZIONE SE JOIN NONCONFORMITA NC ON SE.TIPO=NC.ID WHERE 1=1 AND $grado >= NC.GRADOMINIMO ORDER BY SE.ID";
